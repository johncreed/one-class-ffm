...
num = ad_rank_list.where(ad_rank_list > 200).count()
...
df_click_filter.to_csv("click_filter.csv", index=False)
...
df_events_filter.to_csv("events_filter.csv", index=False)
...
df_ad_filter.to_csv("ad_filter.csv", index=False)
